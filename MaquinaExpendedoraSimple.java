public class MaquinaExpendedoraSimple {
   ...
   public void setReducirPrecioBillete(int reducirPrecioDeBillete){
    
       if (precioBillete>reducirPrecioDeBillete)
       precioBillete = precioBillete - reducirPrecioDeBillete ;
